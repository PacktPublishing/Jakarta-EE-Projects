...
This will create an executable jar file **ebook_catalog-thorntail.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/ebook_catalog-thorntail.jar
