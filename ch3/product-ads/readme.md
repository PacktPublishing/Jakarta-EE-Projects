...
This will create an executable jar file **ebook_related-thorntail.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/ebook_related-thorntail.jar
